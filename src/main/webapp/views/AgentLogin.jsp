...
<img src="images/img1.jpg" style="position:relative;left:50px;padding:10px; width:300px;height:300px">
 <form action="/dld/agentlogin" method="post" onsubmit="return validate()" style="position:absolute;left:470px;padding:10px;top:10px; width:400px">
             ...
             <p>Not a member? <br/><a href="AgentReg.jsp">Register Now</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <a href="forgotpwdAgent.jsp">Forgot Password ? </a></p>
